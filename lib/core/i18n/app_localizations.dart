...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'ar': {
      ...
      'selectSizeAndColor': 'يرجى اختيار المقاس ولون المعدن قبل الإضافة إلى السلة',
      ...
      'itemName': 'اسم العنصر',
      'addItem': 'إضافة عنصر',
      'bulkAddFromUrls': 'استيراد من روابط',
      'sellNow': 'عرض للبيع',
      ...
      'recentlyViewedSubtitle': 'امسح القائمة لإعادة تنشيط الاقتراحات لاحقاً.',
      'clearHistory': 'مسح السجل',
      'historyCleared': 'تم مسح العناصر التي شاهدتها مؤخراً.',
      ...
      'emptyFavorites': 'لم تقم بحفظ أي عناصر بعد.',
      'emptyStateMessage': 'لا توجد بيانات متاحة حالياً.',
      'emptyStateTitle': 'لا شيء هنا بعد',
      'errorStateTitle': 'حدث خطأ',
      'errorStateMessage': 'حدث خطأ غير متوقع، حاول مجدداً لاحقاً.',
      'offlineStateTitle': 'غير متصل',
      'offlineStateMessage': 'لا يوجد اتصال بالإنترنت. تأكد من الشبكة ثم أعد المحاولة.',
    ...
    'en': {
      ...
      'selectSizeAndColor': 'Please pick a ring size and metal color before adding to cart',
      ...
      'itemName': 'Item name',
      'addItem': 'Add Item',
      'bulkAddFromUrls': 'Bulk Add from URLs',
      ...
      'recentlyViewedSubtitle': 'Clear the list to refresh tailored suggestions later.',
      'clearHistory': 'Clear history',
      'historyCleared': 'Recently viewed items cleared.',
      ...
      'emptyFavorites': 'You have not saved any favorites yet.',
      'emptyStateMessage': 'No data available right now.',
      'emptyStateTitle': 'Nothing here yet',
      'errorStateTitle': 'Something went wrong',
      'errorStateMessage': 'An unexpected error occurred. Please try again later.',
      'offlineStateTitle': 'Offline',
      'offlineStateMessage': 'No internet connection detected. Check your network and try again.',
